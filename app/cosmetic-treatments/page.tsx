...
export default function Cosmetic_Treatments() {
  const items = [
    {
      href: "/cosmetic-treatments/bonding",
      label: "Bonding",
      icon: "brush-fill",
      desc: "Repair chips, gaps, and minor imperfections",
    },
    {
      href: "/cosmetic-treatments/veneers",
      label: "Porcelain Veneers",
      icon: "layers-fill",
      desc: "Transform the shape, color, and symmetry of your smile",
    },
    {
      href: "/cosmetic-treatments/whitening",
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-8 pb-24 sm:pb-28 md:pb-32">
              ...
              <p className="mt-4 text-base sm:text-lg md:text-xl max-w-2xl text-white/85">
                Enhance, brighten, and refine your smile with cosmetic dentistry
                options designed to look natural and beautiful.
              </p>
          ...
          <div className="rounded-md border border-blue-950/10 bg-slate-50/90 backdrop-blur shadow-lg p-5 sm:p-6 md:p-7">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <p className="text-sm sm:text-base text-slate-700">
                Select a cosmetic service below to learn how it can enhance your
