    ...
    <div className="min-h-screen w-full flex flex-col bg-slate-100 overflow-x-hidden">
      ...
      >
        ...
        <p className="text-base sm:text-lg md:text-xl max-w-3xl">
          Restoring your smile, your bite, and the natural harmony of your
          teeth.
        </p>
      </section>
      ...
      <section className="w-full bg-slate-200 px-4 sm:px-8 md:px-12 lg:px-20 py-16 sm:py-20">
        <div className="mx-auto max-w-5xl flex flex-col gap-6">
          ...
          <div className="bg-slate-50 shadow-md rounded-md p-6 sm:p-8 md:p-10 flex flex-col gap-4">
            <p className="text-base sm:text-lg md:text-xl leading-7 sm:leading-8">
              A bridge is a device used to replace missing teeth and attaches
            ...
            <p className="text-base sm:text-lg md:text-xl leading-7 sm:leading-8">
              ...
              teeth. Removable bridges are attached to the teeth with metal
        ...
        <div className="mx-auto max-w-5xl flex flex-col gap-6">
          ...
          <div className="bg-slate-50 shadow-md rounded-md p-6 sm:p-8 md:p-10 flex flex-col gap-4">
            <p className="text-base sm:text-lg md:text-xl leading-7 sm:leading-8">
              ...
              wearing a bridge. A bridge helps support your lips and cheeks. The
              loss of a back tooth may cause your mouth to sink and your face to
              look older.
            </p>
            <p className="text-base sm:text-lg md:text-xl leading-7 sm:leading-8">
              Dental health is the most important reason for a bridge. Teeth
              were designed to complement each other. Unusual stresses are
              placed on the gums and other oral tissues when teeth are missing,
              causing a number of potentially harmful disorders.
            </p>
            <p className="text-base sm:text-lg md:text-xl leading-7 sm:leading-8">
            ...
            <p className="font-bold text-base sm:text-lg md:text-xl leading-7 sm:leading-8">
        ...
        <div className="mx-auto max-w-5xl flex flex-col gap-6">
          ...
          <div className="bg-slate-50 shadow-md rounded-md p-6 sm:p-8 md:p-10 flex flex-col gap-4">
            <p className="text-base sm:text-lg md:text-xl leading-7 sm:leading-8">
              ...
              to complete. At the first appointment Dr. Sokol will prepare the
            ...
            <p className="text-base sm:text-lg md:text-xl leading-7 sm:leading-8">
              ...
              teeth are taken and sent to a lab where the bridge will be
              constructed.
            </p>
            <p className="text-base sm:text-lg md:text-xl leading-7 sm:leading-8">
