...
export default function Dental_Health() {
  const items = [
    {
      href: "/dental-health/education",
      label: "Education",
      icon: "book-half",
      desc: "Learn the fundamentals of oral health and prevention",
    },
    {
      href: "/dental-health/maintenance",
      label: "Maintenance",
      icon: "shield-check",
      desc: "Ongoing care to protect your teeth and gums",
    },
    {
      href: "/dental-health/oral-hygiene",
      label: "Oral Hygiene",
      icon: "droplet-half",
      desc: "Daily habits that support a healthy smile",
    },
    {
      href: "/dental-health/pediatrics",
      label: "Pediatrics",
      icon: "emoji-smile",
      desc: "Dental care guidance for children and families",
    },
  ];
    ...
    <div className="min-h-screen w-full flex flex-col bg-slate-100 overflow-x-hidden">
      <section className="relative w-full">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black/35 via-black/25 to-slate-100" />
        </div>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-8 pb-24 sm:pb-28 md:pb-32">
              ...
              <p className="mt-4 text-base sm:text-lg md:text-xl max-w-2xl text-white/85">
                Helpful guidance and resources to support lifelong oral wellness
                — explore our educational topics below.
              </p>
          ...
          <div className="rounded-md border border-blue-950/10 bg-slate-50/90 backdrop-blur shadow-lg p-5 sm:p-6 md:p-7">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <p className="text-sm sm:text-base text-slate-700">
                Choose a topic below to learn how to care for your smile at
                every stage of life.
              </p>
              <Link
                href="/contact"
