    ...
    <div className="min-h-screen flex flex-col bg-slate-100">
      ...
      <section className="w-full bg-slate-200 px-4 sm:px-8 md:px-12 lg:px-20 py-16 sm:py-20 md:py-24">
        <div className="mx-auto max-w-6xl flex flex-col md:flex-row gap-10 md:gap-14 md:items-center">
          <div className="bg-slate-50 shadow-md rounded-md p-8 sm:p-10 flex-1 flex flex-col gap-5">
            ...
            {/* Education */}
            <div className="mt-1 flex flex-col gap-1 text-slate-800">
              <p>
                <i className="bi bi-mortarboard-fill" /> ’77 Hofstra University
              </p>
              <p>
                <i className="bi bi-emoji-smile-fill" /> ’82 Washington
                University School of Dental Medicine
              </p>
              <p>
                <i className="bi bi-award-fill" /> American Dental Association ·
                2nd District Dental Society · Alpha Omega Dental Fraternity
              </p>
            </div>
            ...
            <div className="mt-4">
              ...
              <ul className="list-disc pl-5 text-slate-700 leading-7 mt-1">
                <li>lorem ipsum</li>
                <li>lorem ipsum</li>
                <li>lorem ipsum</li>
              </ul>
      ...
      <section className="w-full px-4 sm:px-8 md:px-12 lg:px-20 py-16 sm:py-20 md:py-24">
        <div className="mx-auto max-w-6xl flex flex-col md:flex-row-reverse gap-10 md:gap-14 md:items-center">
          <div className="bg-slate-50 shadow-md rounded-md p-8 sm:p-10 flex-1 flex flex-col gap-5">
            ...
            <div className="mt-1 flex flex-col gap-1 text-slate-800">
              <p>
                <i className="bi bi-mortarboard-fill" /> ’77 SUNY Farmingdale
              </p>
              <p>
                <i className="bi bi-emoji-smile-fill" /> ’77 NYU College of
                Dentistry
              </p>
            </div>
